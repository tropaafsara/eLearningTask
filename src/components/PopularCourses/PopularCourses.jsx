      ...
      <div className='flex justify-between items-center'>
        ...
        <div className='tab-option '>
          <div
            ...
            className={`tab tab2 remote ms-7 ${activeTab === "design" ? "activetab" : ""
              } `}
          >
            Design
          </div>
          <div
            ...
            className={`tab tab2 remote  ${activeTab === "development" ? "activetab" : ""
              }`}
          >
            Development
          </div>
          <div
            ...
            className={`tab tab2 remote  ${activeTab === "business" ? "activetab" : ""
              }`}
          >
            Business
          </div>
          <div
            ...
            className={`tab tab2 remote  ${activeTab === "data-science" ? "activetab" : ""
              }`}
          >
            Data Science
          </div>
          <div
            ...
            className={`tab tab2 remote me-1 ${activeTab === "marketing" ? "activetab" : ""
              }`}
          >
            Marketing
          </div>
